...
CREATE OR REPLACE AGENT SNOWFLAKE_INTELLIGENCE.AGENTS.CUSTOMER360_AGENT
WITH PROFILE='{ "display_name": "Customer360 Chatbot Agent" }'
...
$$
{
  ...
  "instructions": {
    ...
    "sample_questions": [{
      ...
      "question": "Get the latest information from the following website and analyze its potential impact on our sales forecast for various product categories. Then send me an executive summary email. https://www.bea.gov/news/2025/us-international-trade-goods-and-services-july-2025"
    }, {
  ...
  "tool_resources": {
    ...
    "Search Internal Documents: Finance": {
      "id_column": "FILE_URL",
      "max_results": 5,
      "search_service": "SNOWFLAKE_INTELLIGENCE.TOOLS.SEARCH_FINANCE_DOCS",
      "title_column": "TITLE"
    },
    "Search Internal Documents: HR": {
      "id_column": "FILE_URL",
      "max_results": 5,
      "search_service": "SNOWFLAKE_INTELLIGENCE.TOOLS.SEARCH_HR_DOCS",
      "title_column": "TITLE"
    },
    "Search Internal Documents: Marketing": {
      "id_column": "RELATIVE_PATH",
      "max_results": 5,
      "search_service": "SNOWFLAKE_INTELLIGENCE.TOOLS.SEARCH_MARKETING_DOCS",
      "title_column": "TITLE"
    },
    "Search Internal Documents: Sales": {
      "id_column": "FILE_URL",
      "max_results": 5,
      "search_service": "SNOWFLAKE_INTELLIGENCE.TOOLS.SEARCH_SALES_DOCS",
      "title_column": "TITLE"
    },
    "Send_Emails": {
      "execution_environment": {
